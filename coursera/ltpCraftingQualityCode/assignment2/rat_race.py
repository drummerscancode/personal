    ...
    for r in range(len(maze_list)):
        for c in range(len(maze_list[r])):
            ...
            if maze_list[r][c] == a2.RAT_1_CHAR:
                ...
                maze_list[r][c] = a2.HALL # assumes that the maze can't have a Rat.
            elif maze_list[r][c] == a2.RAT_2_CHAR:
                rat_2 = a2.Rat(a2.RAT_2_CHAR, r, c)
                maze_list[r][c] = a2.HALL # same here
...
def main():
	...
	### Remove the following in order not to prompt all the time for the maze file.
    #with open('/Users/giannaks/..., 'r') as maze_file:
